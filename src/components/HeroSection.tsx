      ...
      <div className="container mx-auto text-center">
        <div className={`max-w-4xl mx-auto transition-all duration-1000 ${
          ...
          <div className="mb-8">
            ...
            <div className="mt-6">
              <p className="text-2xl md:text-3xl font-extralight bg-gradient-to-r from-cyan-300/70 via-blue-300/70 to-purple-300/70 bg-clip-text text-transparent tracking-wide">
                to My Portfolio
              </p>
          ...
          <p className="text-xl md:text-2xl mb-8 font-medium text-gray-800 dark:text-gray-100">
            Computer Science Student | Programmer | Future AI Developer
          </p>
          <p className="text-lg mb-12 max-w-2xl mx-auto text-gray-600 dark:text-gray-300">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button 
              ...
              className="bg-blue-600 hover:bg-blue-700 hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
            >
              View My Work
            </Button>
            <Button 
